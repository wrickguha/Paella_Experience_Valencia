...
import { Save, Globe, ChevronDown, Check, Compass, Info, Users, BookOpen, Star, Sparkles, Type } from 'lucide-react';
...
function sectionFontKey(sectionId: string) {
  ...
  return {
    family: `about_${id}_font_family`,
    size: `about_${id}_font_size`,
  };
}
