    ...
    <div style="max-width: 600px; margin: 40px auto; padding: 0 16px;">
        <div style="background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 10px rgba(15, 23, 42, 0.05); border: 1px solid #e2e8f0;">
            ...
            <div style="background-color: #0f172a; padding: 36px 32px; text-align: center; position: relative; border-bottom: 4px solid #ea580c;">
                <h1 style="color: #ffffff; font-size: 26px; font-weight: 700; margin: 0; letter-spacing: -0.02em;">New Booking Received!</h1>
                <p style="color: #94a3b8; font-size: 14px; margin: 8px 0 0 0; font-weight: 500; text-transform: uppercase; letter-spacing: 0.05em;">A customer has reserved a session</p>
            </div>
            ...
            <div style="padding: 32px 32px 40px 32px;">
                ...
                <p style="font-size: 16px; line-height: 1.6; margin-bottom: 24px; color: #475569;">
                    A new booking has been confirmed on the website. Below are the details of the reservation.
                </p>
                ...
                <div style="background-color: #f8fafc; border: 1px solid #e2e8f0; border-radius: 12px; padding: 18px; margin-bottom: 28px; text-align: center;">
                    <span style="font-size: 12px; text-transform: uppercase; letter-spacing: 0.05em; color: #64748b; font-weight: 600; display: block; margin-bottom: 6px;">Booking Reference</span>
                ...
                <table style="width: 100%; border-collapse: collapse; margin-bottom: 28px;">
                    <tr style="border-bottom: 1px solid #f1f5f9;">
                        <td style="padding: 12px 0; color: #64748b; font-weight: 500; font-size: 14px;">Customer Name</td>
                        <td style="padding: 12px 0; color: #0f172a; font-weight: 600; font-size: 14px; text-align: right;">{{ $booking->first_name }} {{ $booking->last_name }}</td>
                    </tr>
                    <tr style="border-bottom: 1px solid #f1f5f9;">
                        <td style="padding: 12px 0; color: #64748b; font-weight: 500; font-size: 14px;">Email</td>
                        <td style="padding: 12px 0; color: #0f172a; font-weight: 600; font-size: 14px; text-align: right;">{{ $booking->email }}</td>
                    </tr>
                    <tr style="border-bottom: 1px solid #f1f5f9;">
                        <td style="padding: 12px 0; color: #64748b; font-weight: 500; font-size: 14px;">Phone</td>
                        <td style="padding: 12px 0; color: #0f172a; font-weight: 600; font-size: 14px; text-align: right;">{{ $booking->phone ?? '—' }}</td>
                    </tr>
                    <tr style="border-bottom: 1px solid #f1f5f9;">
                    ...
                    <tr style="border-bottom: 1px solid #f1f5f9;">
                        <td style="padding: 12px 0; color: #64748b; font-weight: 500; font-size: 14px;">Experience</td>
                        <td style="padding: 12px 0; color: #0f172a; font-weight: 600; font-size: 14px; text-align: right;">{{ $booking->experience->title_en }}</td>
                    </tr>
                    <tr style="border-bottom: 1px solid #f1f5f9;">
                    ...
                    <tr style="border-bottom: 1px solid #f1f5f9;">
                        <td style="padding: 12px 0; color: #64748b; font-weight: 500; font-size: 14px;">Language Preference</td>
                        <td style="padding: 12px 0; color: #0f172a; font-weight: 600; font-size: 14px; text-align: right;">{{ ucfirst($booking->language_preference ?? 'No preference') }}</td>
                    </tr>
                    @if($booking->coupon_code)
                    <tr style="border-bottom: 1px solid #f1f5f9;">
                        <td style="padding: 12px 0; color: #64748b; font-weight: 500; font-size: 14px;">Coupon Used</td>
                ...
                <div style="background-color: #fffbeb; border-left: 4px solid #f59e0b; padding: 16px; border-radius: 8px; margin-bottom: 32px;">
                    <strong style="color: #b45309; display: block; margin-bottom: 4px; font-size: 14px;">Customer Notes:</strong>
                ...
                <p style="font-size: 15px; color: #475569; margin: 0 0 4px 0;">Happy Hosting!</p>
                <p style="font-size: 15px; color: #475569; margin: 0;">Warm regards,</p>
                <strong style="color: #0f172a; display: block; font-size: 16px; margin-top: 6px;">The SpeakEasy Valencia System</strong>
            </div>
        </div>
